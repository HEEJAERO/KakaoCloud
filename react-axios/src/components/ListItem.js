...
const ListItem = React.memo(({movie}) => {
    console.log("리스트 아이템 컴포넌트");
            ...
            <div className="min-w-0 relative flex-auto">
                ...
                <dl className="mt-2 flex flex-wrap text-sm leading-6 font-medium">
                    ...
                    <div>
                        ...
                        <dd className="px-1.5 ring-1 ring-slate-200 rounded">{movie.vote_average}</dd>
                    </div>
                    <div className="ml-2">
                    ...
                    <div className="flex-none w-full mt-2 font-normal">
                        ...
                        <dd className="text-slate-400">{movie.overview}</dd>
                    </div>
                </dl>
            </div>
        </article>
